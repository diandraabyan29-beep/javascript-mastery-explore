...
let teman = ["Syamil", "Raif", "Budi", "Ihya", "Yudis"];
...
let belanja = [];
belanja.push("Apel", "Pisang", "Jeruk");

belanja.pop();
belanja.shift();

belanja.splice(1, 0, "Mangga");

console.log(`Isi belanjaan: ${belanja}`);
console.log(`Jumlah item belanjaan: ${belanja.length}`);
// ================================================

// 3. Experiment Mandiri Dengan Berbagai Study case Dengan Berbagai Level 
